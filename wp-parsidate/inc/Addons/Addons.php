...
//        add_filter( 'wp_parsidate_' . self::tab . '_tab_content_display_notice', '__return_true' );
    add_filter( 'wp_parsidate_' . self::tab . '_settings_display_reset_button', '__return_false' );
